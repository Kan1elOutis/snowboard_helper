...
SECRET_KEY = 'django-insecure-=6_+z%)+c54rf$24jmmr3fxs_a%lid1(j$!)2(jvw(h8l0u3)x'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('POSTGRES_USER', 'store_username'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'sibdoski'),
